...
export function summaryTransaction(state = defaultState, action) {
    switch (action.type) {
        case FIND_TRANSACTIONS_SUMMARY_REQUEST:
            return {
                ...state,
                loading: true,
                error: null
            };
        case FIND_TRANSACTIONS_SUMMARY_SUCCESS:
            return {
                data: action.data,
                loading: false,
                error: null
            };
        case FIND_TRANSACTIONS_SUMMARY_FAILURE:
            return {
                ...state,
                loading: false,
                error: action.error
