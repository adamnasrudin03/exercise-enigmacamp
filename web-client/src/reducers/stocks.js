...
export function summaryStock(state = defaultState, action) {
    switch (action.type) {
        case FIND_STOCKS_SUMMARY_REQUEST:
            return {
                ...state,
                loading: true,
                error: null
            };
        case FIND_STOCKS_SUMMARY_SUCCESS:
            return {
                data: action.data,
                loading: false,
                error: null
            };
        case FIND_STOCKS_SUMMARY_FAILURE:
            return {
                ...state,
                loading: false,
                error: action.error
